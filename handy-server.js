...
app.get('/golf', 
	function(req, res) {
		...
		//var path = jsonShapes[shape];
		//console.log(path);
		var path = "M-168.2,65.6 -162.8,66.9 -167.0,68.3 -166.3,68.9 -164.0,69.0 -162.5,70.2 -156.6,71.4 -151.3,70.5 -141.0,69.7 -141.0,60.3 -139.1,60.4 -137.5,58.9 -135.2,59.7 -131.8,56.6 -130.1,56.1 -130.0,55.3 -130.6,54.6 -133.6,54.6 -133.8,55.8 -134.6,55.8 -136.5,58.2 -138.3,59.0 -142.3,60.0 -144.7,59.7 -146.0,60.3 -153.0,59.0 -156.2,57.3 -158.0,55.6 -160.0,55.4 -159.2,54.8 -160.3,54.8 -160.2,55.3 -160.9,55.4 -162.4,54.5 -162.6,54.9 -164.8,54.3 -164.5,55.0 -158.9,56.9 -158.1,58.5 -162.2,58.6 -161.9,58.8 -162.2,59.8 -164.0,59.6 -166.3,61.6 -164.9,63.1 -161.3,63.5 -161.1,64.2 -166.3,64.4 -166.9,65.3 -168.2,65.6";
		var retval = pathToPoints(path);
